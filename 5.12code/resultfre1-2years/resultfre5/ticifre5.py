...
if __name__ == "__main__":
    ...
    with open('/home/zjg/code2/resultfre1/resultfre5/0countnumber.tsv','w',newline='')as fcc0:
        y=0
        ...
        #for i in range(0,1):
            ...
            count=[]
            with open('/home/zjg/code2/resultfre1/resultfre5/5Cfre-'+Filelist[i],'w',newline='')as fw0:
                with open('/home/zjg/code2/resultfre1/resultfre5/5Hfre-'+Filelist[i],'w',newline='')as fw1:
                    x=0
