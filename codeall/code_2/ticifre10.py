...
def file_fre(file):
     #读入文件频率
    data=[]
    with open('/home/zjg/code2/resultfre-last_10years/'+'ALL-'+file,'r',encoding='utf-8')as fii:
        for lines in fii:
            json_data=lines
...
if __name__ == "__main__":
    ...
    with open('/home/zjg/code2/resultfre2-10years/0countnumber.tsv','w',newline='')as fcc0:
        y=0
        ...
        #for i in range(0,1):
            ...
            count=[]
            with open('/home/zjg/code2/resultfre2-10years/Cfre-'+Filelist[i],'w',newline='')as fw0:
                with open('/home/zjg/code2/resultfre2-10years/Hfre-'+Filelist[i],'w',newline='')as fw1:
                    x=0
